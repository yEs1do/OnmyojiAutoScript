...
class GameUiAssets: 
	...
	# 六道之门 
	I_EXPLORATION_GOTO_SIX_GATES = RuleImage(roi_front=(1,619,1152,100), roi_back=(1,619,1152,100), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_exploration_goto_six_gates.png")
	# 契灵
	I_EXPLORATION_GOTO_BONDLING_FAIRYLAND = RuleImage(roi_front=(1,619,1152,100), roi_back=(1,619,1152,100), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_exploration_goto_bondling_fairyland.png")
	# description 
