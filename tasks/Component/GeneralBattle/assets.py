...
class GeneralBattleAssets: 
	...
	# Image Rule Assets
	# 奖励，就是那个魂 
	I_REWARD = RuleImage(roi_front=(547,518,172,96), roi_back=(547,518,172,96), threshold=0.6, method="Template matching", file="./tasks/Component/GeneralBattle/gb/gb_reward.png")
	# 预设的小图标 
