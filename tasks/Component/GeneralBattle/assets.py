...
class GeneralBattleAssets: 
	...
	# 确认预设的队伍 
	I_PRESET_ENSURE = RuleImage(roi_front=(393,649,65,33), roi_back=(393,649,65,33), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBattle/gb/gb_preset_ensure.png")
	# 选择buff 
