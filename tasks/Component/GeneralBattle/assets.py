...
class GeneralBattleAssets: 
	...
	# 确认预设的队伍 
	I_PRESET_ENSURE = RuleImage(roi_front=(352,643,141,50), roi_back=(352,643,141,50), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBattle/gb/gb_preset_ensure.png")
	# 选择buff 
