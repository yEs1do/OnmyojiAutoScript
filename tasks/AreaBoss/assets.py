...
class AreaBossAssets: 
	...
	# 除悬赏外 选中第一个鬼王的 
	I_BATTLE_1 = RuleImage(roi_front=(1066,210,100,100), roi_back=(1066,210,100,100), threshold=0.6, method="Template matching", file="./tasks/AreaBoss/res/res_battle_1.png")
	# 除悬赏外 选中第二个鬼王的 
	I_BATTLE_2 = RuleImage(roi_front=(1068,364,100,100), roi_back=(1068,364,100,100), threshold=0.6, method="Template matching", file="./tasks/AreaBoss/res/res_battle_2.png")
	# 除悬赏外 选中第三个鬼王的 
	I_BATTLE_3 = RuleImage(roi_front=(1071,521,100,100), roi_back=(1071,521,100,100), threshold=0.6, method="Template matching", file="./tasks/AreaBoss/res/res_battle_3.png")
	# 点击挑战 
