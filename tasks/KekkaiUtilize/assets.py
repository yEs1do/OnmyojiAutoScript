...
class KekkaiUtilizeAssets: 
	...
	# 收取盒子的经验（没有满） 
	I_BOX_EXP = RuleImage(roi_front=(893,440,42,45), roi_back=(862,396,249,216), threshold=0.7, method="Template matching", file="./tasks/KekkaiUtilize/realm/realm_box_exp.png")
	# 结界皮肤 
